...
<!--		<script async src="http://maps.googleapis.com/maps/api/js?key=AIzaSyBKLPUlQqLD2qnNOAPOMewW9y8h6YYFqVs"></script>-->
	...
	<body <?php body_class(); ?>>
		...
		<!-- Google Code for Konverze Popt&aacute;vka Conversion Page -->
		<script type="text/javascript">
			/* <![CDATA[ */
			var google_conversion_id = 925411765;
			var google_conversion_language = "en";
			var google_conversion_format = "3";
			var google_conversion_color = "ffffff";
			var google_conversion_label = "3LGVCOy55m8QtdOiuQM";
		...
		<noscript>
			...
			src="//www.googleadservices.com/pagead/conversion/925411765/?label=3LGVCOy55m8QtdOiuQM&amp;guid=ON&amp;script=0"/>
			</div>
		</noscript>
